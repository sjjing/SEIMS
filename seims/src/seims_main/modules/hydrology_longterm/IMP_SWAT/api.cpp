...
extern "C" SEIMS_MODULE_API const char *MetadataInformation() {
    ...
    mdi.AddInput(VAR_OLFLOW, UNIT_DEPTH_MM, DESC_OLFLOW, Source_Module, DT_Raster1D); /// OL_Flow
    mdi.AddInput(VAR_DEET, UNIT_DEPTH_MM, DESC_DEET, Source_Module_Optional, DT_Raster1D); /// DEET
    mdi.AddInput(VAR_DPST, UNIT_DEPTH_MM, DESC_DPST, Source_Module_Optional, DT_Raster1D); /// DPST
    mdi.AddInput(VAR_SEDYLD, UNIT_KG, DESC_SEDYLD, Source_Module, DT_Raster1D); /// SED_OL
